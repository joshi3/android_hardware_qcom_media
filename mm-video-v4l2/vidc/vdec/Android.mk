...
libmm-vdec-inc          += $(TOP)/hardware/qcom/sm8150/media/mm-video-v4l2/vidc/common/inc
libmm-vdec-inc          += $(TOP)/hardware/qcom/sm8150/media/mm-core/inc
libmm-vdec-inc          += hardware/qcom/sm8150/media/libplatformconfig
libmm-vdec-inc          += $(TARGET_OUT_HEADERS)/adreno
libmm-vdec-inc      	+= $(TOP)/hardware/qcom/sm8150/media/libc2dcolorconvert
libmm-vdec-inc      	+= $(TARGET_OUT_HEADERS)/mm-video/SwVdec
libmm-vdec-inc      	+= $(TARGET_OUT_HEADERS)/mm-video/swvdec
libmm-vdec-inc      	+= $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr/include
libmm-vdec-inc      	+= $(TOP)/hardware/qcom/sm8150/media/libarbitrarybytes/inc
...
libmm-vdec-inc += $(TOP)/hardware/qcom/sm8150/media/hypv-intercept
endif
# ---------------------------------------------------------------------------------
